...
#include "omniKafkaConsumerCadre.generated.h"

// Forward declaration to avoid direct dependency
class AActor;

UCLASS()
class KAFKA16_API AomniKafkaConsumerCadre : public AActor
{
	GENERATED_BODY()

public:
	// Sets default values for this actor's properties
	AomniKafkaConsumerCadre();
...
private:
	...
	// File path to the JSON file (you can customize this path)
	FString JsonFilePath = "C:/Users/Pard1/Desktop/kafkaUnrealConsumer_1_hsml.json";
